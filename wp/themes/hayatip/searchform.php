<form role="search" id="searchform" method="get" action="<?php echo home_url( '/' ); ?>" class="side-search">
    <div class="side-search_box">
        <input class="side-search_box_text" name="s" id="s" type="text" value="" placeholder="検索できます">
        <button class="side-search_box_button" id='searchsubmit' type="submit">
