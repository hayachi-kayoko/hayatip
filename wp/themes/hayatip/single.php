...
<?php
        ...
        $cat = $cat[0];
        ?>
        <h2 class="main-archive_title main-archive_title--<?php echo $cat->slug; ?>"><?php echo $cat->name; ?></h2>
        ...
        <ul class="breadcrumbs_group">
            <li class="breadcrumbs_group_item breadcrumbs_group_item--home">
             ...
             <li class="breadcrumbs_group_item">
                <a href="<?php echo home_url(); ?>/all"><span>商品一覧</span></a>
             </li>
             <li class="breadcrumbs_group_item">
       ...
       <div class="main-single_inner">
            ...
            <article class="main-single_inner_content">
                ...
                <div class="single-links">
                    ...
                    <?php
                    $valueMinne = get_post_meta($post->ID, 'minne-url', true);?>
                    <?php if(empty($valueMinne)):?>
                        <li class='single-links_group_empty'></li>
                    <?php else: ?>
                        <li><a href="<?php echo get_field('minne-url');?>" target="_blank"><img src="<?php echo get_template_directory_uri();?>/image/minne.png" alt="minne"></a></li>
                    <?php endif;?>

                    <?php
                    $valuecreema = get_post_meta($post->ID, 'creema-url', true);?>
                    <?php if(empty($valuecreema)):?>
                        <li class='single-links_group_empty'></li>
                    <?php else: ?>
                        <li><a href="<?php echo get_field('creema-url');?>" target="_blank">creema</a></li>
                    <?php endif;?>

                    <?php
                    $valuebase = get_post_meta($post->ID, 'base-url', true);?>
                    <?php if(empty($valuebase)):?>
                        <li class='single-links_group_empty'></li>
                    <?php else: ?>
                        <li><a href="<?php echo get_field('base-url');?>" target="_blank"><img src="<?php echo get_template_directory_uri();?>/image/base.png" alt="base"></a></li>
                    <?php endif;?>

                    <?php
                    $valuemercari = get_post_meta($post->ID, 'mercari-url', true);?>
                    <?php if(empty($valuemercari)):?>
                        <li class='single-links_group_empty'></li>
                    <?php else: ?>
                        <li><a href="<?php echo get_field('mercari-url');?>" target="_blank"><img src="<?php echo get_template_directory_uri();?>/image/mercari.png" alt="mercari"></a></li>
                    <?php endif;?>
